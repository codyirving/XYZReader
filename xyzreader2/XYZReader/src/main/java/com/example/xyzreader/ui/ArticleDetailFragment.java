...
public class ArticleDetailFragment extends Fragment implements
    ...
    public static ArticleDetailFragment newInstance(long itemId, int position, int startingPosition) {
        ...
        System.out.println("ArticleDetailFrag newInstance: itemId: " + itemId + " position: " + position + " startingPosition: " + startingPosition);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                System.out.println("RESPONDING TO UPBUTTON");
    ...
    private void bindViews() {
      ...
      //  bylineView.setMovementMethod(new LinkMovementMethod());
        ...
        if (mCursor != null) {
            ...
            System.out.println("bindviews:mcursor!=Null");
...
//                                        .setBackgroundColor(mMutedColor);
                                ...
                                System.out.println("SettingScrimColor!:" + colorDrawable.getColor());
                               //((CollapsingToolbarLayout) mRootView.findViewById(R.id.photo_container)).setStatusBarScrim(colorDrawable);
